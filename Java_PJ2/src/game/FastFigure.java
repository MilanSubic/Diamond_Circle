...
public class FastFigure extends Figure {
    ...
    public FastFigure(Color color,int numberOfJumps) {
    ...
    public void setNumberOfJumps(int numberOfJumps) {
        super.setNumberOfJumps(numberOfJumps * 2);
    }
    ...
    public String toString(){
        ...
        return this.getFigureName()+" ( fast figure, "+color+" )"+" Predjeni put: "+  tempList.toString()+" Figura završila kretanje: "+figureEnd+"\n";
