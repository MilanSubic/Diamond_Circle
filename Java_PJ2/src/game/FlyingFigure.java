...
public class FlyingFigure extends Figure {
    ...
    public FlyingFigure(Color color, int numberOfJumps) {
    ...
    public String toString(){
        ...
        return this.getFigureName()+" ( flying figure, "+color+" )"+" Predjeni put: "+  tempList.toString()+" Figura završila kretanje: "+figureEnd+"\n";
